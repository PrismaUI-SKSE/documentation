...
Join our Skyrim UI Modding <a href='https://discord.gg/bawdketrFX' target='_blank'>Discord Community Server!</a>
</Aside>
...
<CardGrid>
  ...
  <Card title="Effective" icon="rocket">
    Optimized WebKit engine delivers good performance with minimal memory footprint - perfect for gaming.
  </Card>
...
4. **Media Keys Fix SKSE** (for keyboard input)
...
If you're new to SKSE plugin development, we recommend starting with the [CommonLib-NG](https://github.com/alandtse/CommonLibVR/tree/ng) and our [example plugin](https://github.com/PrismaUI-SKSE/example-skse-plugin) to understand the basics.
</Aside>
