...
For a fully working example, check out our [example plugin repository](https://github.com/PrismaUI-SKSE/example-skse-plugin) which demonstrates all the concepts covered in this guide.
</Aside>
...
void InitializeUI() {
    ...
    PrismaUI->RegisterJSListener(view, "onPlayerAction", [](const char* data) -> void {
        ...
        } else if (action == "unfocus_menu") {
            // Unfocus the menu
            SKSE::log::info("Unfocusing menu...");
    ...
    <div class="ui-container">
        ...
        <main class="ui-main">
            ...
            <section class="actions">
                ...
                <button onclick="unfocusMenu()" class="action-btn unfocus-btn">
                    Unfocus Menu
                </button>
            </section>
...
function unfocusMenu() {
    window.onPlayerAction('unfocus_menu');
    addResponse('Unfocus menu requested');
}
...
PrismaUI->Invoke(view, "getCurrentSettings()", [](const char* data) -> void {
    SKSE::log::info("Current settings: {}", data);
