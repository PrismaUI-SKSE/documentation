...
---
## Version 1.1.0-rc <Badge text="Latest Features" variant="note" />

[Download](https://github.com/PrismaUI-SKSE/framework/releases/download/1.1.0-rc/PrismaUI_1_1_0-rc.zip)
...
## Version 1.0.0 <Badge text="Stable" variant="success" />
