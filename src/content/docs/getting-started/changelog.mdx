...
---
## Version 1.5.0 <Badge text="Latest" variant="success" />

[Download](https://github.com/PrismaUI-SKSE/framework/releases/download/1.5.0/PrismaUI.zip)

- Added VR support (Open Composite)
- Added beta gamepad controller support
- Added Skyrim 1.7 version support
- Bugfixes and improvements

---
## Version 1.4.1

[Download](https://github.com/PrismaUI-SKSE/framework/releases/download/1.4.1/PrismaUI_1.4.1.zip)

- Added new `RegisterConsoleCallback` API method to `IVPrismaUI2` - interface
- Added IME partial support
- Fixed `WndProc` hook installation issue
- Updated CommonLib-NG version to `4.2.0` version
