...
import MouseInteractiveBackground from './mouse-interactive-background';
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <motion.p
          className="text-xl md:text-3xl text-zinc-400 mb-4 max-w-4xl mx-auto"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.p
          className="text-lg md:text-xl text-zinc-500 mb-12 max-w-3xl mx-auto"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, delay: 0.6 }}
        >
          Create beautiful and modern user interfaces for Skyrim with HTML, CSS, JavaScript, React,
        ...
        >
          ...
          <motion.a
            ...
            className="group relative px-8 py-4 bg-transparent border-2 border-zinc-700 text-white rounded-xl font-semibold text-lg overflow-hidden"
