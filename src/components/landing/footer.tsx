...
export default function Footer() {
  const links = {
    product: [
      ...
      { name: 'API Reference', href: '/api/create-view/' },
      { name: 'Examples', href: 'https://github.com/PrismaUI-SKSE/example-skse-plugin' },
      { name: 'Changelog', href: '/getting-started/changelog/' },
    ],
    community: [
      { name: 'Discord', href: 'https://discord.gg/bawdketrFX' },
      { name: 'GitHub', href: 'https://github.com/PrismaUI-SKSE' },
      { name: 'Report Issues', href: 'https://github.com/PrismaUI-SKSE/framework/issues' },
    ],
    resources: [
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        ...
        >
          <p className="text-zinc-600 text-sm">
            © {new Date().getFullYear()} Prisma UI. Created with ❤️ by{' '}
            <a
              href="https://github.com/StarkMP"
              target="_blank"
              rel="noopener noreferrer"
              className="text-zinc-400 hover:text-white transition-colors"
            >
          ...
          <p className="text-zinc-600 text-sm">Made for the Skyrim modding community</p>
        </motion.div>
      </div>
    </footer>
  );
